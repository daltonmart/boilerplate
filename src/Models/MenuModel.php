...
class MenuModel extends Model
{
     ...
     private function getMenuDriverMySQLi($id)
    {
        ...
        return $this->db->table('menu')
            ->select("menu.id, menu.parent_id, menu.active, menu.title, menu.icon, menu.route, groups_menu.menu_id, group_concat("+$DBPrefix+"groups_menu.group_id SEPARATOR '|') as group_id")
    ...
    private function getMenuDriverMySQLi_old_for_delete($id)
    {        
        return $this->db->table('menu')
